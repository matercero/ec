 ...
 */
package es.matercero.ec.beans;

import es.matercero.ec.hibernate.Cliente;
import es.matercero.ec.services.IClienteService;
import es.matercero.ec.utils.CartasPDF;
import es.matercero.ec.utils.Utilidades;
...
public class ClienteBean implements Serializable {
    ...
    private List<Cliente> listaSelectedCliente;
    ...
    public void generarCartas() {
        ...
        if (listaSelectedCliente.isEmpty()) {
            Utilidades.setMessage(FacesMessage.SEVERITY_INFO, "No ha seleccionado ningun entidad-persona",
                    "No ha seleccionado ningun entidad-persona.");
            return;
        }

        StringBuilder seleccionados = new StringBuilder();
        for (Cliente cliente : listaSelectedCliente) {
            seleccionados.append(cliente.getNombre());
        }
        new CartasPDF().lanzar(listaSelectedCliente);

        Utilidades.setMessage(FacesMessage.SEVERITY_INFO, "Se han generado cartas",
                "Se han generado cartas." + seleccionados);

    }

    /**
     * @return the listaSelectedCliente
     */
    public List<Cliente> getListaSelectedCliente() {
        return listaSelectedCliente;
    }

    /**
     * @param listaSelectedCliente the listaSelectedCliente to set
     */
    public void setListaSelectedCliente(List<Cliente> listaSelectedCliente) {
        this.listaSelectedCliente = listaSelectedCliente;
    }
