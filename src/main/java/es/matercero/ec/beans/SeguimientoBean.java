...
import es.matercero.ec.hibernate.SeguimientoComponente;
import es.matercero.ec.services.IMantenimientoService;
...
public class SeguimientoBean implements Serializable {
    ...
    public String newSeguimiento(ActionEvent actionEvent) {
    ...
    public List<Componente> getListaComponentes() {
        Iterator<SeguimientoComponente> it = selectedSeguimiento.getSeguimientoComponenteSet().iterator();
        SeguimientoComponente sc = it.next();
        sc.getComponente();
        List<Componente> c = new ArrayList<Componente>();
        c.add(sc.getComponente());
        return c;
    }
